...
from sqlalchemy import Column, String, Integer, SmallInteger, TIMESTAMP, Index
"""
商户信息表
"""
...
class Merchant(Base):
    ...
    status = Column(SmallInteger, default=0, comment="商户状态， 0: 待审核的商户  1: 已审核通过的商户 2: 已拒绝的商户")
