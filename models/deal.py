...
from sqlalchemy import Column, String, BigInteger, Integer, Float, SmallInteger, TIMESTAMP, Index
"""
订单信息表
"""
...
class Deal(Base):
    ...
    origin_money = Column(Float, default=0, comment="订单折扣前总金额")
    money = Column(Float, default=0, comment="订单折后总金额")
    need_delivery = Column(SmallInteger, default=0, comment="订单是否需要配送")
    deal_status = Column(SmallInteger, default=0, comment="订单状态, 0: 待支付  1:待派送 2:待上门领取 3:派送中 4:已拒收 5:已完成")
    ...
    creator_phone = Column(String(16), default="", comment="联系人手机号")
    content = Column(String(4096), default="[]", comment="订单内容")
